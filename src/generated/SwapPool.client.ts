...
import { Uint128, BalanceResponse, ExecuteMsg, Expiration, Timestamp, Uint64, TokenSelect, Addr, InfoResponse, InstantiateMsg, QueryMsg, Token, Token1ForToken2PriceResponse, Token2ForToken1PriceResponse } from "./SwapPool.types";
export interface SwapPoolReadOnlyInterface {
...
export class SwapPoolQueryClient implements SwapPoolReadOnlyInterface {
...
export interface SwapPoolInterface extends SwapPoolReadOnlyInterface {
  contractAddress: string;
  sender: string;
  addLiquidity: ({
    expiration,
...
export class SwapPoolClient extends SwapPoolQueryClient implements SwapPoolInterface {
